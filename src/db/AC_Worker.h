...
signals:
  ...
  */
  ...
  /* Function: available (signal)
     Emitted when a requested image is available. See <AutoCache::available>
     for details.
   */
  void available(quint64 version, QSize requested, Image16 img);

  /* Function: exception (signal)
     Emitted when this thread catches an exception.
...
private:
  /* Function: respondToRequest
     Emits <available> signals for the given image.
  */

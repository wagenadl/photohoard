...
public:
  ...
  bool operator!=(Image const &) const;
  // Basic information
  uint width() const { return f==Format::Color16 ? d.width()/3 : d.width(); }
  ...
  bool isGrayscale() const { return f==Format::Gray8 || f==Format::Gray16; }
  bool is8Bits() const { return f==Format::Gray8 || f==Format::Color8; }
